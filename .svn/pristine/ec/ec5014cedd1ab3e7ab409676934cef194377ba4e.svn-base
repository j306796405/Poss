(function() {
  ...
  angular
    ...
    .controller('auth.domain.DomainCreateController', DomainCreateController);

  DomainCreateController.$inject = [
    '$timeout',
    '$state',
    '$scope',
  ...
  function DomainCreateController($timeout, $state, $scope, notificationService, authorityService, domainService) {
